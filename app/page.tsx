...
export default function LandingPage() {
  ...
  const handleVideoError: React.ReactEventHandler<HTMLVideoElement> = (event) => {
    ...
    console.error('Attempted video source:', video.src);
  };

  const handleVideoLoad: React.ReactEventHandler<HTMLVideoElement> = () => {
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#111' }}>
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <video
          ...
          muted
        >
          <source src="/videos/vantare-video.mp4" type="video/mp4" />
        </video>
